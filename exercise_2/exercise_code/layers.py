...
def affine_forward(x, w, b):
    ...
    #############################################################################
    shapes = np.shape(x)
    out = np.reshape(x, (shapes[0], -1)).dot(w) + [b]
    #############################################################################
    #                             END OF YOUR CODE                              #
    #############################################################################
    cache = (x, w, b)
...
def affine_backward(dout, cache):
    ...
    dx = np.reshape(dx, shapes)
    dw = np.transpose(np.reshape(x, (shapes[0], -1))).dot(dout)
    db = np.sum(dout, 0)
    #############################################################################
    #                             END OF YOUR CODE                              #
    #############################################################################
...
def softmax_loss(x, y):
    ...
    """
    numerical_stabilizer = 1e-20
    # 1e-10 was given, but induces incorrect calculation of loss in 1e-10 precision
